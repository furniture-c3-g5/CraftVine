...
router.put(
  "/admin/users/restor_user/:id",
  admin_controller.restore_deleted_user
);
...
router.put(
  "/admin/product/soft_delete/:id",
  admin_controller.product_soft_delete
);
router.put(
  "/admin/product/product_restore/:id",
  admin_controller.product_restore
);

router.put(
  "/admin/product/set_best_seller/:product_id",
  admin_controller.set_best_seller
);
router.put(
  "/admin/product/unset_best_seller/:product_id",
  admin_controller.unset_best_seller
);
...
router.post("/contact", admin_controller.contact);
router.post("/admin/contact_messages", admin_controller.contact_messages);
