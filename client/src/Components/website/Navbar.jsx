      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <Link to="/" className="flex items-center">
            <img src={logo} className="mr-3 h-20" alt="CraftVine Logo" />
          </Link>
          <div className="flex md:order-2">
            ...
            <Link to='/y'>
              ...
              >
                <div class="relative">
                  <div class={`${user === null? 'hidden': 'block'} t-0 absolute left-3`}>
                  ...
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class={`file: h-6 w-6${user !== null? 'mt-4': 'mt-0'}`}
                  >
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
          ...
          >
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <Link
                  to="/"
                  className="block py-2 pl-3 pr-4 text-white bg-teal-600 rounded md:bg-transparent md:text-teal-600 md:p-0 md:dark:text-blue-500"
                  aria-current="page"
                >
                  Home
                </Link>
